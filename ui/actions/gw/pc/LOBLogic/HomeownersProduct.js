...
const pcfCategory = {
    selectInput: ['IdentityTheftProtectionLimit', 'IdentityTheftProtectionDeductible', 'LossAssessmentLimit'],
    textInput: [],
    checkBox: ['IdentityTheftProtection', 'LossAssessment', 'FirstAid']
}
